            ...
            <form className="p-6 md:p-8" onSubmit={(e) => e.preventDefault()}>
              <div className="flex flex-col gap-4">
                ...
                <div className="text-center">
                  <h1 className="font-sans text-2xl font-bold text-foreground">สร้างบัญชีของคุณ</h1>
                  <p className="mt-1 font-sans text-sm text-muted-foreground">กรุณาป้อนอีเมลของคุณด้านล่างเพื่อสร้างบัญชี</p>
                </div>

                {/* Full name */}
                <div className="grid gap-1.5">
                  <Label htmlFor="fullname" className="font-sans text-sm font-medium text-foreground">ชื่อเต็ม</Label>
                ...
                <p className="text-center font-sans text-sm text-muted-foreground">
                  มีบัญชีอยู่แล้ว?{' '}
                  <Link href="/login" className="font-semibold text-brand no-underline transition-colors hover:text-brand/80">
                    เข้าสู่ระบบ
                  </Link>
                </p>
